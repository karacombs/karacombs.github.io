...
Below is an overview of my educational background, experience, and research funding. I also am committed to advancing my profession and community through active service and leadership. My involvement spans professional societies, outreach initiatives, and advisory roles to advance the growth of science, technology, engineering, and mathematics (STEM) disciplines.
...
function initCertCarousel() {
  ...
  certCarousel.items.forEach(card => {
    card.addEventListener('click', (e) => {
      if (certCarousel.hasMoved && certCarousel.dragDistance > 10) {
        e.preventDefault();
        e.stopPropagation();
        return false;
      }
...
function certDragMove(e) {
  ...
  certCarousel.dragDistance = Math.abs(diff);
  
  if (certCarousel.dragDistance > 10) {
    e.preventDefault();
...
<div class="member-carousel" data-carousel="memberCarousel">
  ...
  <div class="member-carousel-wrapper" id="memberCarousel">
    ...
    <a href="https://www.mors.org/" class="member-card" target="_blank">
      <div class="member-card-image has-img" style="background-color: white;">
        <img src="https://www.trideum.com/wp-content/uploads/2023/06/MORS-logo.png" alt="MORS" style="object-fit: contain;">
      </div>
      <div class="member-card-content">
        <div class="status">Student Member</div>
...
function initMemberCarousel() {
  ...
  memberCarousel.items.forEach(card => {
    card.addEventListener('click', (e) => {
      if (memberCarousel.hasMoved && memberCarousel.dragDistance > 10) {
        e.preventDefault();
        e.stopPropagation();
        return false;
      }
...
function memberDragMove(e) {
  ...
  memberCarousel.dragDistance = Math.abs(diff);
  
  if (memberCarousel.dragDistance > 10) {
    e.preventDefault();
